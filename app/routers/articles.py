...
# 'templates' is in the app/__init__.py.
...
@router.get(
    path="",
    summary="Gets the articles page",
    tags=["Pages"],
...
#         "partials/reminders/new-list-row-edit.html", context
#     )
...
#     item_id: int, storage: ReminderStorage = Depends(get_storage_for_page)
# ):
...
#     context = {"request": request}
#     return templates.TemplateResponse(
#         "partials/reminders/new-item-row-edit.html", context
#     )
